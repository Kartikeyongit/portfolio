...
export const spaProjects: OtherProject[] = [
  ...
  },
  {
    slug: 'mono-studio',
    title: 'Mono® Studio',
    tagline: 'Creative studio site with GSAP motion choreography, Three.js particle mark, and Lenis smooth scrolling',
    description:
      'An immersive creative agency website for Mono® studio (brand · motion · product) with a Three.js particle logo mark, GSAP scroll-triggered choreography, magnetic UI interactions, custom cursor, preloader, and a Lenis smooth-scroll experience.',
    thumbnail: '/images/projects/mono-studio/thumbnail.webp',
    category: 'frontend',
    stack: ['Next.js 16', 'React 19', 'TypeScript', 'Tailwind CSS 4', 'GSAP', 'Three.js', 'Lenis', 'Framer Motion'],
    githubUrl: 'https://github.com/Kartikeyongit/mono-studio',
    liveUrl: 'https://mono-studio-mu.vercel.app/',
    highlights: [
      'Custom Three.js particle logo mark rendered on WebGL with camera animation and scroll-driven interactivity',
      'GSAP ScrollTrigger choreography across hero, manifesto, work, services, and process sections with magnetic hover effects',
      'Lenis smooth scrolling with custom easing, branded preloader, grain overlay, and custom cursor for a cinematic feel',
    ],
    metrics: [
